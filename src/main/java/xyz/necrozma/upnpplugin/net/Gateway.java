    ...
    private Map<String, String> command(String action, Map<String, String> params) throws Exception {
        ...
        if (params != null)
            for (Map.Entry<String, String> entry : params.entrySet())
                soap = soap + "<" + (String)entry.getKey() + ">" + (String)entry.getValue() + "</" + (String)entry.getKey() + ">";
        ...
        NodeIterator iter = ((DocumentTraversal)d).createNodeIterator(d.getDocumentElement(), 1, null, true);
        Node n;
